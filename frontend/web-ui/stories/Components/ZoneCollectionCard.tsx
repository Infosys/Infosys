...
export interface ZoneCollectionCardProps {
  zone: ZoneData;
}

export const ZoneCollectionCard: React.FC<ZoneCollectionCardProps> = ({ zone }) => {
...
export interface ZoneCollectionDashboardProps {
  zones?: ZoneData[];
  searchTerm?: string;
  onSearchChange?: (value: string) => void;
}

export const ZoneCollectionDashboard: React.FC<ZoneCollectionDashboardProps> = ({
  zones = [],
  searchTerm = '',
  onSearchChange
}) => {
