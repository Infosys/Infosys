...
export interface PropertyApplicationCardProps {
  application: PropertyApplication;
  onViewApplication?: (id: string) => void;
}

export const PropertyApplicationCard: React.FC<PropertyApplicationCardProps> = ({ application, onViewApplication }) => (
...
export interface PropertyApplicationsListProps {
  applications?: PropertyApplication[];
  title?: string;
}

export const PropertyApplicationsList: React.FC<PropertyApplicationsListProps> = ({ applications = [], title = 'Property Applications' }) => (
