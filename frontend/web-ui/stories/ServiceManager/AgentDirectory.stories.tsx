...
import { dashboardContainer, dashboardHeader, mainContentGrid, cardSection, sectionTitle, subtitleText, titleText } from '../../src/app/features/service-manager-app-features/service-manager-dashboard/styles/ServiceManagerDashboard/ServiceManagerDashboardStyle';
import { AgentCard } from '../../src/app/features/service-manager-app-features/service-manager-dashboard/components/ServiceManagerDashboard/AgentCard';
import type { AgentModel } from '../../src/app/features/service-manager-app-features/service-manager-dashboard/models/ServiceManagerDashboard/Agent_Model';
...
const meta: Meta<typeof AgentDirectory> = {
  title: 'ServiceManager/AgentDirectory',
