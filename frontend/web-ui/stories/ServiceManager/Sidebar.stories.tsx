...
import { Sidebar } from '../../src/app/components/Sidebar/SM_Sidebar';
import { serviceManagerPrimaryItems } from '../../src/app/components/Sidebar/sidebarConfig';
import { Box } from '@mui/material';

const meta: Meta<typeof Sidebar> = {
  title: 'ServiceManager/Sidebar',
  component: Sidebar,
  parameters: {
    layout: 'fullscreen',
    docs: {
