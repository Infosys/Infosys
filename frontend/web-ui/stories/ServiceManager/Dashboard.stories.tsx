...
import { dashboardContainer, dashboardHeader, mainContentGrid, cardSection, sectionTitle, subtitleText, titleText, dashboardLoadingContainer, dashboardErrorContainer, dashboardErrorAlert } from '../../src/app/features/service-manager-app-features/service-manager-dashboard/styles/ServiceManagerDashboard/ServiceManagerDashboardStyle';
import { ApplicationCard } from '../../src/app/features/service-manager-app-features/service-manager-dashboard/components/ServiceManagerDashboard/ApplicationCard';
  ...
  const applications = [
    {
      ...
      AssesseeID: null,
      Property: { ID: 'P-1', PropertyNo: '12', OwnershipType: 'Private', PropertyType: 'Residential', ComplexName: '12 MG Road', Address: { WardNo: 'Ward-01', Street: 'MG Road', City: 'Bangalore' }, AssessmentDetails: null, Amenities: [], ConstructionDetails: null, AdditionalDetails: null, GISData: null, CreatedAt: new Date().toISOString(), UpdatedAt: new Date().toISOString(), Documents: [] },
      ApplicationLogs: [],
      IsDraft: false,
    ...
    },
    {
      ...
      AppliedBy: 'Sita Devi',
      AssesseeID: null,
      Property: { ID: 'P-2', PropertyNo: '45', OwnershipType: 'Private', PropertyType: 'Residential', ComplexName: '45 Park Avenue', Address: { WardNo: 'Ward-01', Street: 'MG Road', City: 'Bangalore' }, AssessmentDetails: null, Amenities: [], ConstructionDetails: null, AdditionalDetails: null, GISData: null, CreatedAt: new Date().toISOString(), UpdatedAt: new Date().toISOString(), Documents: [] },
      ApplicationLogs: [],
      IsDraft: false,
      CreatedAt: new Date().toISOString(),
      UpdatedAt: new Date().toISOString(),
...
const meta: Meta<typeof MockDashboard> = {
  title: 'ServiceManager/ServiceManagerDashboard',
