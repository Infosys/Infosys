...
interface WardStatisticsCardProps {
  ward: WardStatistics;
}


const WardStatisticsCard: React.FC<WardStatisticsCardProps> = ({ ward }) => {
  return (
    <Card 
      sx={{ 
        borderRadius: '12px',
...
interface WardStatisticsListProps {
  wards?: WardStatistics[];
  title?: string;
}

const WardStatisticsDashboard: React.FC<WardStatisticsListProps> = ({ 
  wards = [],
