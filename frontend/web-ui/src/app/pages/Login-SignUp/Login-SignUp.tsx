  ...
  const handleLogin = async () => {
    try {
      ...
      if (success) {
        ...
        // More specific error message for unauthorized roles
        setError(
          "Access denied. Your role is not authorized to access this portal."
        );
        setShowAlert(true);
      }
    } catch {
        ...
        >
          <Box sx={{ mt: 1 }}>
            ...
            <LoginHeaderWithLanguage
              LanguageButtonProp={{ onClick: () => setLangModalOpen(true) }}
            />
