// This file contains the CommissionerSidebar component, which renders the sidebar navigation for the Commissioner dashboard.
// It supports toggling, primary/secondary navigation, and profile/settings/help actions.
...
// Props for the CommissionerSidebar component
...
export interface CommissionerSidebarProps {
  open: boolean;
  onToggle: () => void;
  selectedNav: string;
...
export const CommissionerSidebar: React.FC<CommissionerSidebarProps> = ({ 
  open, 
  onToggle, 
  selectedNav, 
  onSelectNav, 
