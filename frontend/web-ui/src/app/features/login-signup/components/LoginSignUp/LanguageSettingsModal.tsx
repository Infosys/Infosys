...
// LanguageSettingsModal allows users to select and confirm their preferred language
...
// Props for LanguageSettingsModal
export interface LanguageSettingsModalProps {
    open: boolean; // Whether the modal is open
    selected?: string; // Currently selected language code
    onSelect: (code: string) => void; // Callback when a language is selected
    onClose: () => void; // Callback to close the modal
    onConfirm: () => void; // Callback to confirm selection
}
