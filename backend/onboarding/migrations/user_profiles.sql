...
CREATE TABLE user_profiles (
    ...
    adhaar_no               BIGINT ,                                -- Aadhaar number (unique constraint)
    ...
    relationship_to_property VARCHAR(50) NOT NULL DEFAULT '',       -- Relationship to the property
    ...
    CONSTRAINT userprofile_id_fkey FOREIGN KEY (user_profile_id) REFERENCES users(keycloak_user_id) ON DELETE CASCADE, -- Foreign key to the users table
