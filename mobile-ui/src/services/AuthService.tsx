...
import { KEYCLOAK_TOKEN_URL } from '../config/env';
import {
  getUserByUsername,
  setAppLocale,
  getAppLocale,
...
class AuthService {
  ...
  public primaryRole: 'CITIZEN' | 'AGENT' | null = null;
  ...
  try {
    if (this.user) {
      const lastLocale = localStorage.getItem('appLocale') || getAppLocale() || 'en';
      try {
  ...
  getPrimaryRoleFromToken(): 'CITIZEN' | 'AGENT' | null {
