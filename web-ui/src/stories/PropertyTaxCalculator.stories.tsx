...
// Property Tax Calculator Card interface
interface PropertyTaxCalculatorCard {
  id: string;
  propertyName: string;
...
const PropertyTaxCalculator: React.FC<PropertyTaxCalculatorProps> = ({ property }) => {
    ...
    >
      <CardContent sx={{ p: 0 }}>
        ...
        >
          ...
          {/* Property Tax Calculator Button: "Property tax" on first line, "calculator" on second line */}
          <Button
            variant="contained"
...
interface PropertyTaxCalculatorListProps {
...
const PropertyTaxCalculatorList: React.FC<PropertyTaxCalculatorListProps> = ({
  properties = [],
